...
/**
 * @description Retrieves a font from the cache or fetches it from the server.
 * @param {string} fontFace - The name of the font face.
 * @returns {Promise<string>} - A promise that resolves to the font data as a string.
 */
